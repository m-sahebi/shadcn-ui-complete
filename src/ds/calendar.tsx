...
import { buttonVariants } from '#src/ds/button';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'ui-flex',
        head_cell: 'ui-text-muted-foreground ui-rounded-md ui-w-8 ui-font-normal ui-text-[0.8rem]',
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className="ui-h-4 ui-w-4" />,
        IconRight: ({ ...props }) => <ChevronRightIcon className="ui-h-4 ui-w-4" />,
      }}
      {...props}
    />
  );
